# SDM4 importer til cprregister

## Igang
cprimporteren er af typen der bruger en AuditingPersister
...
Klon repo med ```git clone https://github.com/trifork/sdm4-cprimporter.git```.
